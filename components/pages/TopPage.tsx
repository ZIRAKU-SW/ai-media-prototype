...
const DUMMY_ARTICLES: Article[] = [
  { id:'1', title:'ChatGPT-4oの新機能まとめ｜業務で使える7つの活用例', slug:'chatgpt-4o-business', excerpt:'OpenAIが発表したGPT-4oの最新機能を徹底解説。営業メール作成から資料作りまで、すぐに使える具体的なプロンプト例付きで紹介します。', content:null, thumbnail_url:'https://placehold.co/600x340/0d2b6b/4fc3f7?text=ChatGPT+4o', is_published:true, is_members_only:false, reading_time_minutes:8, view_count:1240, published_at:'2026-05-20', created_at:'2026-05-20', categories:{ name:'AI活用ガイド', slug:'ai-guide', color:'#3B82F6' } },
  { id:'2', title:'中小企業のDXとは？成功するための3つのステップ', slug:'sme-dx-steps', excerpt:'DX推進を検討している中小企業向けに、具体的な始め方とよくある失敗パターンを解説。', content:null, thumbnail_url:'https://placehold.co/600x340/10B981/ffffff?text=DX+Guide', is_published:true, is_members_only:false, reading_time_minutes:6, view_count:980, published_at:'2026-05-19', created_at:'2026-05-19', categories:{ name:'DX・業務改善', slug:'dx-improvement', color:'#10B981' } },
  { id:'3', title:'Notion AIの使い方完全ガイド｜議事録作成を10倍効率化', slug:'notion-ai-guide', excerpt:'Notion AIを使って議事録・報告書・企画書の作成を劇的に効率化する方法を解説。', content:null, thumbnail_url:'https://placehold.co/600x340/8B5CF6/ffffff?text=Notion+AI', is_published:true, is_members_only:false, reading_time_minutes:7, view_count:870, published_at:'2026-05-18', created_at:'2026-05-18', categories:{ name:'ツール比較', slug:'tools', color:'#6B7280' } },
  { id:'4', title:'1人社長がAIで月商100万を達成した具体的な方法', slug:'solo-president-ai', excerpt:'少人数でもAIを駆使してマーケ・営業・CS を回した実例。使ったツールとプロンプトを公開。', content:null, thumbnail_url:'https://placehold.co/600x340/F59E0B/ffffff?text=Solo+AI', is_published:true, is_members_only:false, reading_time_minutes:9, view_count:1560, published_at:'2026-05-17', created_at:'2026-05-17', categories:{ name:'1人社長・副業・起業', slug:'solo-business', color:'#8B5CF6' } },
  { id:'5', title:'営業メール作成ツールを30分で作ってみた【実験室】', slug:'lab-sales-email-tool', excerpt:'Claude APIを使って営業メール自動生成ツールを実際に作った記録。コードと使用感を全公開。', content:null, thumbnail_url:'https://placehold.co/600x340/EF4444/ffffff?text=Lab', is_published:true, is_members_only:false, reading_time_minutes:10, view_count:2100, published_at:'2026-05-16', created_at:'2026-05-16', categories:{ name:'実験室・開発ブログ', slug:'lab', color:'#EF4444' } },
  { id:'6', title:'おすすめAIツール30選【2026年最新版】', slug:'ai-tools-2026', excerpt:'業務効率化・コンテンツ作成・データ分析など用途別にAIツールを厳選して紹介。', content:null, thumbnail_url:'https://placehold.co/600x340/6B7280/ffffff?text=AI+Tools', is_published:true, is_members_only:false, reading_time_minutes:12, view_count:3200, published_at:'2026-05-15', created_at:'2026-05-15', categories:{ name:'ツール比較', slug:'tools', color:'#6B7280' } },
]
