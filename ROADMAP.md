...
| **ziraku 本番想定UI（バックボーン7ページ）** | ✅ 完了 | 記事一覧/詳細・カテゴリ・サービス・会社情報・セミナー・プライバシー |
| **ziraku デザイン寄せ込み（親しみ路線）** | ✅ 完了 | ドラフト原画準拠：ヒーロー/会員バナー/ロゴ/ファビコン・角丸/ピル統一 |
| **ziraku 記事詳細 SSR / OGP** | ✅ 完了 | generateMetadata + ISR 300s（SEO対応） |
...
| デザイン確定 | 🔶 一部決定 | ziraku は**親しみ路線**（サイトイメージ1）採用済み。3パターン比較の最終結論は未 |
| サイト名確定 | ⬜ 未着手 | **要意思決定** |
