...
from (values
  ('【2026年最新】生成AIをビジネスで活用する方法｜用途別に徹底解説',
   ...
   'https://placehold.co/800x450/0d2b6b/4fc3f7?text=AI+Business+Guide',
  ...
  ('ChatGPT・Claude・Gemini 徹底比較｜あなたのビジネスに最適なのはどれ？',
   ...
   'https://placehold.co/800x450/4B5563/ffffff?text=AI+Tools+Compare',
  ...
  ('議事録作成をAIで完全自動化する方法｜今日から使えるプロンプト付き',
   ...
   'https://placehold.co/800x450/10B981/ffffff?text=AI+Minutes+Auto',
  ...
  ('在庫管理を自動化して在庫ロスを80%削減した小売業のDX事例',
   ...
   'https://placehold.co/800x450/059669/ffffff?text=DX+Case+Study',
  ...
  ('1人社長がChatGPTだけで月商100万を達成した全手順',
   ...
   'https://placehold.co/800x450/8B5CF6/ffffff?text=Solo+AI+100man',
  ...
  ('営業メール作成ツールを30分で作ってみた【実験室 #01】',
   ...
   'https://placehold.co/800x450/EF4444/ffffff?text=Lab+Email+Tool',
  ...
  ('【2026年最新】AIが変える意外な世界｜匂い生成・犬語翻訳・ロボット僧侶まで',
   ...
   'https://placehold.co/800x450/F59E0B/ffffff?text=AI+Trend+2026',
  ...
  ('おすすめAIツール30選【2026年最新版】業務別に徹底比較',
   ...
   'https://placehold.co/800x450/6B7280/ffffff?text=AI+Tools+30',
